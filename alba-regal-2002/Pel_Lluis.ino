...
// inicialitzar el sensor DHT (temperatura i humitat)
DHT dht(DHTPIN, DHTTYPE); 

// inicialitzar la pantalla LCD amb 20 caràcters i 4 línies útils
LiquidCrystal_I2C lcd(0x27, 20, 4);

//display al serial monitor
...
// lectura dels diferents sensors
...
//escriure els valors mesurats al serial monitor d'arduino
...
//escriure els valors mesurats a la pantalla LCD
